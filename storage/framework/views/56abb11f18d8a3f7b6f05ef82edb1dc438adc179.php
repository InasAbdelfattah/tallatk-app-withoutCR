<?php $__env->startSection('content'); ?>
    <form method="POST" action="<?php echo e(route('provider.storeProvider')); ?>" enctype="multipart/form-data" data-parsley-validate
          novalidate>
                ...
                <div class="card-box">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input class="form-control name" type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="اسم مزود الخدمة" required>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
                            ...
                            <input class="form-control phoneCenter" type="tel" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="رقم الجوال" required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control name" type="text" name="name_ar" value="<?php echo e(old('name_ar')); ?>" placeholder="اسم المركز عربى" required>
                        <p class="help-block" id="error_userName"></p>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control name" type="text" name="name_en" value="<?php echo e(old('name_en')); ?>" placeholder="اسم المركز انجليزى" required>
                        <p class="help-block" id="error_userName"></p>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control description" name="description_ar" value="<?php echo e(old('description_ar')); ?>" placeholder="وصف المركز عربى" required><?php echo e(old('description_ar')); ?></textarea>
                        <p class="help-block" id="error_userName"></p>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control description" name="description_en" value="<?php echo e(old('description_en')); ?>" placeholder="وصف المركز انجليزى" required><?php echo e(old('description_en')); ?></textarea>
                        <p class="help-block" id="error_userName"></p>
