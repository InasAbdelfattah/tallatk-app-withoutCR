        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card-box">
                    ...
                    <!--               value="<?php echo e($setting->getBody('about_app_name')); ?>" class="form-control"-->
                    <!--               required-->
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <input type="hidden" name="about_app_image_old"
                                   value="<?php echo e($setting->getBody('about_app_image')); ?>">
                            <input type="file" name="about_app_image" class="dropify" data-max-file-size="6M"
                                   data-default-file="<?php echo e(request()->root() . '/' . $setting->getBody('about_app_image')); ?>"/>
