...
<head>
    ...
    <!-- App CSS -->
    <link href="<?php echo e(request()->root()); ?>/assets/admin/css/bootstrap-rtl.min.css" rel="stylesheet"
          type="text/css"/>
    ...
    <script src="<?php echo e(request()->root()); ?>/assets/admin/js/modernizr.min.js"></script>
...
<script src="<?php echo e(request()->root()); ?>/assets/admin/assets/js/jquery.core.js"></script>
<script src="<?php echo e(request()->root()); ?>/assets/admin/assets/js/jquery.app.js"></script>
