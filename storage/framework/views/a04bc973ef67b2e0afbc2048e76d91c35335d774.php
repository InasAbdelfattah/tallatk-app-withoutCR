        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card-box">
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="site_title"
                                   value="<?php echo e($setting->getBody('site_title')); ?>" class="form-control"
                    ...
                    <div class="col-xs-12">
                        <div class="form-group <?php echo e($errors->has('site_content') ? 'has-error' : ''); ?>">
                            ...
                            <textarea id="editor" name="site_content" data-parsley-required-message="هذا الحقل إلزامي" data-parsley-maxlength="5000"
                               data-parsley-maxlength-message="تجاوزت الحد الأقصى لعدد الحروف المسموحة وهى 5000 ">
                                <?php echo e($setting->getBody('site_content')); ?>
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="playstore"
                                   value="<?php echo e($setting->getBody('playstore')); ?>" class="form-control"
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="appstore"
                                   value="<?php echo e($setting->getBody('appstore')); ?>" class="form-control"
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <input type="hidden" name="site_image_old"
                                   value="<?php echo e($setting->getBody('site_image')); ?>">
                            <input type="file" name="site_image" class="dropify" data-max-file-size="6M" accept="image/*"
                                   data-default-file="<?php echo e(request()->root() . '/' . $setting->getBody('site_image')); ?>" data-show-remove="false" data-allowed-file-extensions="pdf png gif jpg jpeg" data-errors-position="outside" required data-parsley-required-message="هذا الحقل إلزامي" />
