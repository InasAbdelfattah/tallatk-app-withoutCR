    ...
    <div class="row zoomIn">
        <div class="col-sm-12">
            <!-- <div class="btn-group pull-right m-t-15">
                ...
                <a href="<?php echo e(route('users.createProvider')); ?>" type="button" class="btn btn-custom waves-effect waves-light"
            ...
            <div class="card-box">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 btn-group">
                        ...
                        <a href="<?php echo e(route('users.providers_requests')); ?>" type="button" class="btn btn-custom waves-effect waves-light" aria-expanded="false"> طلبات مزودى الخدمات
                            <span class="m-l-5">
                                <i class="fa fa-user"></i>
                            </span>
                        </a>
                ...
                <table id="datatable-fixed-header" class="table  table-striped">
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <!--<td><a target="_blank" href="<?php echo e(route('companies.show', $user->company_id)); ?>">تفاصيل المركز: <?php echo e($user->company_name); ?></a></td>-->
                            ...
                            <td>
                                ...
                                <a href="javascript:;" id="activateRow<?php echo e($user->id); ?>" data-id="<?php echo e($user->id); ?>" data-status="<?php echo e($user->is_suspend); ?>"
                            ...
                            <td>
                                <a href="<?php echo e(route('companies.show', $user->company_id)); ?>"class="btn btn-icon btn-xs waves-effect btn-default m-b-5">
                                    <i class="fa fa-eye"></i></a>
                                
                                <a href="<?php echo e(route('users.editProvider',$user->id)); ?>"
    ...
    $('body').on('click', '.elementStatus', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(route('user.activateProvider')); ?>',
