                ...
                <div class="card-box">
                    ...
                    <div class="col-xs-12">
                        <div class="form-group {{ $errors->has('terms_ar') ? 'has-error' : '' }}">
                            <label for="terms_ar">بنود الاستخدام عربى</label>
                    ...
                    <div class="col-xs-12">
                        <div class="form-group {{ $errors->has('terms_en') ? 'has-error' : '' }}">
                            <label for="terms_en">بنود الاستخدام انجليزى</label>
                    ...
                    <!--<div class="col-xs-12">-->
                    <!--    <div class="form-group {{ $errors->has('providerTerms_ar') ? 'has-error' : '' }}">-->
                    ...
                    <!--           data-parsley-maxlength-message="تجاوزت الحد الأقصى لعدد الحروف المسموحة وهى 5000 ">-->
                    <!--            {{ $setting->getBody('providerTerms_ar') }}-->
                    <!--        </textarea>-->
                    <!--    </div>-->
                    ...
                    <!--<div class="col-xs-12">-->
                    <!--    <div class="form-group {{ $errors->has('providerTerms_en') ? 'has-error' : '' }}">-->
                    ...
                    <!--           data-parsley-maxlength-message="تجاوزت الحد الأقصى لعدد الحروف المسموحة وهى 5000 ">-->
                    <!--            {{ $setting->getBody('providerTerms_en') }}-->
                    <!--        </textarea>-->
                    <!--    </div>-->
