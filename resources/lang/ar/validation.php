...
return [
    ...
    */
    ...
    'date_format'   => 'صيغة الحقل :attribute يجب أن تكون على الشكل ساعة:دقيقة مثال : 09:00',
    'after_or_equal'=> 'صيغة الحقل :attribute يجب أن يكون أكبر من أو يساوى الوقت الحالى',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'attributes'           => [
        ...
        'from' => 'من',
        'to'=>'الى',
        'name_ar'               => 'العنوان عربى',
        'name_en'               => 'العنوان انجليزى',
